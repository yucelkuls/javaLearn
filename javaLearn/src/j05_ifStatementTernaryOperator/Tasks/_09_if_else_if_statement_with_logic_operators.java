...
public class _09_if_else_if_statement_with_logic_operators {
    ...
    public static void main(String[] args) {
      ...
      /* str bir String'dir.
        ...
        else if (str.equals("Apple") && str.length() == 5) System.out.println("Apple has five letters");
        else if (str.contains("Orange") && str.length() > 10) System.out.println("String contain orange and length is more then 10");

...
public class C04_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        System.out.println("dtf1.format(today) = " + dtf1.format(today));
        System.out.println("dtf2.format(today) = " + dtf2.format(today));
        System.out.println("dtf3.format(today) = " + dtf3.format(today));

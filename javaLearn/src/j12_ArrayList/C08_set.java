...
public class C08_set {
    public static void main(String[] args) {
        ...
        System.out.println("ulkeList set yapilmadan once = " + ulkeList); // [Almanya, Isvec, Danimarka, Belcika, Hollanda, Finlandiya]
        System.out.println("ulkeList.set(2, \"Izlanda\") = " + ulkeList.set(2, "Izlanda")); // Danimarka
        System.out.println("ulkeList set den sonra = " + ulkeList); // [Almanya, Isvec, Izlanda, Belcika, Hollanda, Finlandiya]
        System.out.println("ulkeList.set(7, \"Turkiye\") = " + ulkeList.set(7, "Turkiye")); // .IndexOutOfBoundsException Olmayan index!!!

...
public class C09_subList {
    public static void main(String[] args) {
        ...
        System.out.println("subList oncesi ulkeList = " + ulkeList); // [Almanya, Isvec, Danimarka, Belcika, Hollanda, Finlandiya]
        System.out.println("ulkeList.subList(1,4) = " + ulkeList.subList(1, 4)); // [Isvec, Danimarka, Belcika]
        System.out.println("subList sonrasi ulkeList = " + ulkeList); // [Almanya, Isvec, Danimarka, Belcika, Hollanda, Finlandiya]
